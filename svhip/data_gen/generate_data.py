...
def unpack_select_parameters(param):
    return param[1], param[2], param[4], param[5], param[6], param[7], param[8]
...
def create_training_set(filename, param, outfilename, gen_neg = 0, function_log = None):
    ...
    """
    minid, maxid, k, window_size, n_proc, mute, step = unpack_select_parameters(param)
...
def build_data(argx=None, inputfile=None, outfile=None, function_log = None):
    ...
    if '-readall' in calls:
        if os.path.isdir(in_path):
            ...
            lg_message = "FATAL: -readall flag is set but input is not a valid directory."
...
def testset_cr(argx = None, inputfile=None, outfile=None, flog=None, t=None):
    ...
    #global function_log
    function_log = flog
    outfile = build_data(argx, inputfile, outfile, function_log)
    return outfile
